...
[![My Skills](https://skillicons.dev/icons?i=cpp,c,cs,java,js,html,css,bootstrap,materialui,tailwind,react,vue,nodejs,jest,python&perline=10)](https://skillicons.dev)

### Tools:

[![My Tools](https://skillicons.dev/icons?i=git,github,npm,yarn,redux,mysql,mongodb,visualstudio,vscode,figma,postman,vite,wordpress&perline=15)](https://skillicons.dev)
